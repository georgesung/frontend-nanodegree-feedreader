...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
        it('defined non-empty URL', function() {
         ...
         */
        it('defined non-empty name', function() {
            for (var i = 0; i < allFeeds.length; i++) {
    ...
    describe('The Menu', function() {
        ...
        it('changes visibility when the menu icon is clicked', function() {
            // Initially, the menu is invisible
            // Perform the following 3 times to catch corner cases (e.g. functionality only works for the first 2 clicks)
            for (var i = 0; i < 3; i++) {
                // Trigger a click on the menu icon, and expect the menu to be visible
                $('.menu-icon-link').trigger('click');
                expect($('body').attr('class')).not.toBe('menu-hidden');

                // Trigger a click on the menu icon, and expect the menu to be invisible
                $('.menu-icon-link').trigger('click');
                expect($('body').attr('class')).toBe('menu-hidden');
            }
        });
